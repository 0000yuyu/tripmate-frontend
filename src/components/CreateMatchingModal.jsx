  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const payload = {
        ...
        scheduledAt: formData.recruitedAt || null,
        recruitedAt: formData.scheduledAt || null,
        ...
        tf: formData.tf || null,
        pj: formData.pj || null,
        preferenceGender: formData.preferenceGender || null,
        allowSmoking: formData.allowSmoking
      };

      console.log('create matching payload:', payload);
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-6 bg-black/40 backdrop-blur-sm">
          ...
          >
            <div className="p-8 border-b border-gray-100 flex items-center justify-between">
              <h2 className="text-2xl font-black text-[#333333]">매칭 생성</h2>
